...
var Home = (_dec = (0, _redaction.connect)(function (_ref) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Orders2.default, {
            ...
            handelReplaceHistory: this.handelReplaceHistory,
  ...
  this.handelReplaceHistory = function (sellCurrency, buyCurrency) {
    var _props2 = _this2.props,
        ...
        buy = _props2$match$params.buy,
        sell = _props2$match$params.sell;


    if (filter && filter.length > 0 && !buy && !sell) {
      filter = filter.split('-');
      _this2.handelReplaceHistory(filter[1], filter[0]);
    } else {
