...
=======
exports.default = {"propENV":"testnet.prod","paths":{},"referral":{"url":"https://wiki.swap.online/affiliate.php"},"publicPath":"https://testnet.swap.online/","http":{"host":"localhost","port":9001},"i18nDate":{"month":"long","day":"numeric","hour":"numeric","minute":"numeric"},"exchangeRates":{"swapeth":1,"ethswap":1,"swapnoxon":1,"noxonswap":1,"swapbtc":0.07,"btcswap":0.07,"etheth":1,"ethbtc":0.07,"btceth":14,"ethnoxon":1,"noxoneth":1,"btcnoxon":0.07,"noxonbtc":0.07},"env":"production","entry":"testnet","base":"https://testnet.swap.online/","services":{"web3":{"provider":"https://rinkeby.infura.io/JCnK5ifEPH9qcQkX0Ahl","rate":0.1,"gas":2000000,"gasPrice":"20000000000"},"eos":{"chainId":"038f4b0fc8ff18a4f0842a8f0564611f6e96e8535901dd45e43ac8691a1c4dca","httpEndpoint":"https://jungle.eosio.cr"}},"ipfs":{"swarm":"/dns4/discovery.libp2p.array.io/tcp/9091/wss/p2p-websocket-star/","server":"discovery.libp2p.array.io"},"token":{"contract":"0xc87C2668F05803F60EF75b176eea0CCE80D0009C"},"eth":{"contract":"0x830aef165b900fa7dc6b219f062c5784f6436d67"},"tokens":{"swap":{"address":"0xbaa3fa2ed111f3e8488c21861ea7b7dbb5a7b121","decimals":18},"noxon":{"address":"0x60c205722c6c797c725a996cf9cca11291f90749","decimals":0},"jot":{"address":"0x9070e2fDb61887c234D841c95D1709288EBbB9a0","decimals":18}},"link":{"bitpay":"https://test-insight.bitpay.com","etherscan":"https://rinkeby.etherscan.io","eos":"http://jungle.cryptolions.io/#accountInfo"},"api":{"blocktrail":"https://api.blocktrail.com/v1/tBTC","bitpay":"https://testnet.y000r.world/insight-api","etherscan":"https://rinkeby.etherscan.io/api"},"apiKeys":{"etherscan":"RHHFPNMAZMD6I4ZWBZBF6FA11CMW9AXZNM","blocktrail":"1835368c0fa8e71907ca26f3c978ab742a7db42e"}};
>>>>>>> f7606b75ddde93844507a83737fa4966af610739:app.c3faa2.js
...
var _ModalConductor = __webpack_require__(1245);
...
var _Notification = __webpack_require__(1250);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 1254));
...
var _Coins = __webpack_require__(182);
...
var _Href = __webpack_require__(183);
...
var _bignumber = __webpack_require__(184);
...
var _NotificationConductor = __webpack_require__(1246);
...
var _ImportKeys = __webpack_require__(1241);
...
var _ImportKeys = __webpack_require__(1242);

var _ImportKeys2 = _interopRequireDefault(_ImportKeys);

var _Group = __webpack_require__(1243);
...
var ImportKeys = (_dec = (0, _reactCssModules2.default)(_ImportKeys2.default), _dec(_class = function (_Component) {
  ...
  function ImportKeys() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ImportKeys.__proto__ || (0, _getPrototypeOf2.default)(ImportKeys)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      try {
        new _bitcoinjsLib2.default.ECPair.fromWIF(btcKey, network); // eslint-disable-line
      } catch (e) {
        _this.setState({
          isValidNetwork: true
        });
      ...
      var _this$state = _this.state,
          ethKey = _this$state.ethKey,
          btcKey = _this$state.btcKey,
      ...
      if (!isDisabled) {
        isImportedEth && localStorage.setItem(_helpers.constants.privateKeyNames.eth, ethKey);
        isImportedBtc && localStorage.setItem(_helpers.constants.privateKeyNames.btc, btcKey);
        window.location.reload();
      }
  ...
  (0, _createClass3.default)(ImportKeys, [{
    ...
    value: function render() {
      var _state = this.state,
          ...
          isValidNetwork = _state.isValidNetwork,
      ...
      if (isValidNetwork) {
        linked.btcKey.check(function (value) {
          return !value;
        }, 'Please enter another network private key');
      }
...
var _Group = __webpack_require__(1244);
...
var _notifications = __webpack_require__(1247);
...
var _NotificationConductor = __webpack_require__(1253);
...
var _SuccessWithdraw = __webpack_require__(1248);

var _SuccessWithdraw2 = _interopRequireDefault(_SuccessWithdraw);

var _Message = __webpack_require__(1251);
...
var _SuccessWithdraw = __webpack_require__(1249);
...
var _Message = __webpack_require__(1252);
